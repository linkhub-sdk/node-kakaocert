...
function KakaocertService(config) {
    ...
    if(this.UseGAIP){
      this.ServiceURL = 'ga-kakaocert-api.linkhub.co.kr';
    } else if(this.UseStaticIP){
      this.ServiceURL = 'static-kakaocert-api.linkhub.co.kr';
    } else {
...
KakaocertService.addMethod(KakaocertService.prototype, 'requestCMS', function(ClientCode, RequestCMS, success, error){
    this.requestCMS(ClientCode, RequestCMS, false, success, error);
});
...
KakaocertService.addMethod(KakaocertService.prototype, 'requestESign', function(ClientCode, RequestESign, success, error){
    this.requestESign(ClientCode, RequestESign, false, success, error);
});
