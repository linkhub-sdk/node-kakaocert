...
KakaocertService.addMethod(KakaocertService.prototype, 'getCMSResult', function(ClientCode, ReceiptID, success, error){
  if(!ClientCode || 0 === ClientCode.length) {
    this._throwError(-99999999,'이용기관코드가 입력되지 않았습니다.',error);
    return;
  }
...
KakaocertService.addMethod(KakaocertService.prototype, 'getVerifyAuthResult', function(ClientCode, ReceiptID, success, error){
  if(!ClientCode || 0 === ClientCode.length) {
    this._throwError(-99999999,'이용기관코드가 입력되지 않았습니다.',error);
    return;
  }
...
KakaocertService.addMethod(KakaocertService.prototype, 'getESignResult', function(ClientCode, ReceiptID, success, error){
...
KakaocertService.addMethod(KakaocertService.prototype, 'getESignResult', function(ClientCode, ReceiptID, Signature, success, error){
  ...
  this._executeAction({
    uri : '/SignToken/'+ReceiptID+'/'+Signature,
    ClientCode : ClientCode,
    Method : 'GET',
    success : function(response){
      if(success) success(response);
